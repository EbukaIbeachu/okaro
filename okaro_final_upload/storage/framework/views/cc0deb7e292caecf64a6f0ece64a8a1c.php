...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-link text-center">Already have an account? Login</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\EasyPHP-Devserver-17\eds-www\okaro\resources\views/auth/register.blade.php ENDPATH**/ ?>