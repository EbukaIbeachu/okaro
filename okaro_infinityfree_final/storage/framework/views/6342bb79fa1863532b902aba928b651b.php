...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row g-0">
            ...
            <div class="sidebar" id="sidebarMenu">
                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('buildings.*') ? 'active' : ''); ?>" href="<?php echo e(route('buildings.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('rents.*') ? 'active' : ''); ?>" href="<?php echo e(route('rents.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('maintenance.*') ? 'active' : ''); ?>" href="<?php echo e(route('maintenance.index')); ?>">
                    ...
                    <div class="px-3 pb-3">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="flex-grow-1 ms-2 overflow-hidden">
                                <div class="small fw-bold text-truncate"><?php echo e(Auth::user()->name); ?></div>
            ...
            <!-- Main Content -->
            <main class="<?php if(auth()->guard()->check()): ?> main-content <?php else: ?> col-12 <?php endif; ?>">
                <?php if(auth()->guard()->check()): ?>
...
<?php /**PATH C:\Program Files\EasyPHP-Devserver-17\eds-www\okaro\resources\views/layouts/app.blade.php ENDPATH**/ ?>