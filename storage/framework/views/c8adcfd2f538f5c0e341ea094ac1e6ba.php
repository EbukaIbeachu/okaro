...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?php echo e(route('buildings.index')); ?>" class="btn btn-sm btn-secondary">
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('buildings.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name')); ?>" required maxlength="150">
...
unset($__errorArgs, $__bag); ?>" id="total_units" name="total_units" value="<?php echo e(old('total_units')); ?>" required min="1">
...
unset($__errorArgs, $__bag); ?>" id="total_floors" name="total_floors" value="<?php echo e(old('total_floors')); ?>" required min="1">
...
unset($__errorArgs, $__bag); ?>" id="address_line1" name="address_line1" value="<?php echo e(old('address_line1')); ?>" required maxlength="200">
...
unset($__errorArgs, $__bag); ?>" id="address_line2" name="address_line2" value="<?php echo e(old('address_line2')); ?>" maxlength="200">
...
unset($__errorArgs, $__bag); ?>" id="city" name="city" value="<?php echo e(old('city')); ?>" required maxlength="100">
...
unset($__errorArgs, $__bag); ?>" id="state" name="state" value="<?php echo e(old('state')); ?>" required maxlength="100">
...
unset($__errorArgs, $__bag); ?>" id="postal_code" name="postal_code" value="<?php echo e(old('postal_code')); ?>" required maxlength="20">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\EasyPHP-Devserver-17\eds-www\okaro\resources\views/buildings/create.blade.php ENDPATH**/ ?>